...
#ifdef CNC_SHIELD
#define THETA1_PULSE_PIN 2
#define THETA2_PULSE_PIN 3
#define THETA3_PULSE_PIN 4

#define THETA1_DIRECTION_PIN 5
#define THETA2_DIRECTION_PIN 6
#define THETA3_DIRECTION_PIN 7

#define THETA1_ENABLE_PIN 8
#define THETA2_ENABLE_PIN 8
#define THETA3_ENABLE_PIN 8

#define THETA1_ENDSTOP_PIN 9
#define THETA2_ENDSTOP_PIN 10
